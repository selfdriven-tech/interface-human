/*
	...
	http://selfdriven.foundation/levelup
...
app.add(
{
	...
	code: function (param)
	{
		...
		if (_.isNotSet(levelUpProfileProject))
		{
			_.set(param, 'onComplete', 'util-level-up-profile-challenges-project-check-process');

			app.invoke('level-up-project-init', param);
		}
		else
		{
			app.invoke('util-level-up-profile-challenges-project-check-process', param)
		}
	}
});
...
app.add(
{
	name: 'util-level-up-profile-challenges-project-check-process',
	code: function (param, response)
	{
		...
		if (_.isNotSet(levelUpProfileProject))
		{
			app.notify({type: 'error', message: 'There is an issue with the set up of your level up project.'})
		}
		else
		{
			if (response == undefined)
			{
				mydigitalstructure.cloud.search(
				{
					...
					callback: 'util-level-up-profile-challenges-project-check-process',
					callbackParam: param
				});
			}
			else
