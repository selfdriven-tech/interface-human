/*
	{
    	title: "Learning Partner; Connections", 	
...
app.add(
{
	name: 'learning-partner-connections',
	...
	{		
		...
		if (response == undefined && relationshipTypes == undefined)
		{
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections'
			});
		}
		else
		{
			var typesView = app.vq.init({queue: 'learning-partner-connections-types'});
			...
			[
				...
				'<ul class="dropdown-menu mt-1"',
					'data-controller="learning-partner-connections-dashboard"',
					'data-context="type"',
				'>',
				'<li>',
			...
			typesView.render('#learning-partner-connections-types');

			app.invoke('learning-partner-connections-dashboard');
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard',
	code: function (param, response)
	{
		var data = app.get(
		{
			scope: 'learning-partner-connections-dashboard',
			valueDefault: {}
		});
		...
		if (response == undefined)
		{
			...
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard'
			})
		}
		else
		{
			var connectionsView = app.vq.init({queue: 'learning-partner-connections-dashboard'});
			...
			else 
			{
					...
					'<div class="col-sm-12 mb-3 mt-1">',
						'<div class="card">',
							'<div class="card-body pt-3 pb-3">',
								'<div class="row mr-0">',
									'<div class="col-2 col-sm-2 text-center pl-0 pr-2">',
									...
									'<div class="col-2 text-right pr-0">',
										'<a class="btn btn-link btn-sm text-muted myds-collapse-toggle"',
											...
											' href="#learning-partner-connections-dashboard-collapse-{{relationship.contactperson.guid}}"',
										'>',
								...
								'</div>',
							'</div>',
							'<div class="collapse myds-collapse" id="learning-partner-connections-dashboard-collapse-{{relationship.contactperson.guid}}"',
								' data-controller="learning-partner-connections-dashboard-show"',
								' data-guid="{{relationship.contactperson.guid}}"',
								' data-id="{{relationship.contactperson.id}}">',

								'<div class="card-body pt-1">',
									'<div class="row mr-0">',
										'<div class="col-1 text-center pl-0 pr-2">',
										'</div>',
											...
											'<ul class="nav nav-tabs myds-tab">',
												'<li class="nav-item">',
													'<a class="nav-link active" data-toggle="tab" ',
														' href="#learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-projects"',
														' data-guid="{{relationship.contactperson.guid}}"',
														' data-controller="learning-partner-connections-dashboard-show-projects">',
														'<i class="fe fe-folder"></i> Projects',
													'</a>',
												'</li>',
												'<li class="nav-item">',
													'<a class="nav-link" data-toggle="tab" ',
														' href="#learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-skills"',
														' data-guid="{{relationship.contactperson.guid}}"',
														' data-controller="learning-partner-connections-dashboard-show-skills">',
														'<i class="fe fe-sun"></i> Skills',
													'</a>',
												'</li>',
												'<li class="d-none nav-item">',
													'<a class="nav-link" data-toggle="tab" ',
														' href="#learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-tokens"',
														' data-guid="{{relationship.contactperson.guid}}"',
														' data-controller="learning-partner-connections-dashboard-show-tokens">',
														'<i class="fe fe-disc"></i> Tokens',
													'</a>',
												'</li>',
												'<li class="nav-item">',
													'<a class="nav-link" data-toggle="tab" ',
														' href="#learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-level-up-profile"',
														' data-guid="{{relationship.contactperson.guid}}"',
														' data-controller="learning-partner-connections-dashboard-show-level-up-profile">',
														'<i class="fe fe-user"></i> Level Up Profile',
													'</a>',
												'</li>',
											'</ul>',
											'<div class="tab-content">',
												'<div class="tab-pane active pt-2" id="learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-projects">',
													'<div class="text-secondary mt-2 mb-0">',
														'Projects you are supporting {{relationship.contactperson.firstname}} with.',
													'</div>',
													'<div id="learning-partner-connections-dashboard-view-{{relationship.contactperson.guid}}-projects">',
													'</div>',
												'</div>',
												'<div class="tab-pane pt-2" id="learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-skills">',
													'<div class="text-secondary mt-2 mb-0">',
														'Skills issued by you to {{relationship.contactperson.firstname}}.',
													'</div>',
													'<div id="learning-partner-connections-dashboard-view-{{relationship.contactperson.guid}}-skills">',
													'</div>',
												'</div>',
												'<div class="tab-pane pt-2" id="learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-tokens">',
													'<div class="text-secondary mt-2 mb-0">',
														'Tokens assigned by you for {{relationship.contactperson.firstname}}.',
													'</div>',
													'<div id="learning-partner-connections-dashboard-view-{{relationship.contactperson.guid}}-tokens">',
													'</div>',
												'</div>',
												'<div class="tab-pane pt-2" id="learning-partner-connections-dashboard-show-{{relationship.contactperson.guid}}-level-up-profile">',
													'<div class="text-secondary mt-2 mb-0">',
														'{{relationship.contactperson.firstname}}\'s Level Profile and your supporting reflections on it.',
													'</div>',
													'<div class="mt-3" id="learning-partner-connections-dashboard-view-{{relationship.contactperson.guid}}-levelup-profile">',
													'</div>',
												'</div>',
											'</div>',
										'</div>',
				...
				_.each(response.data.rows, function (row)
				{
					...
					if (false && row['relationship.contactperson._howgoing'])
					{
						row.howgoinginfo = 
							'<div class="px-0 mb-4">' +
								'<label class="form-check-label mb-1 w-100" for="learner-wellbeing-howgoing">' +
									'<div class="text-muted float-left font-weight-bold">Could be better</div>' +
									'<div class="text-muted float-right font-weight-bold"><i class="fad fa-thumbs-up mr-1 text-muted"></i> Going OK</div>' +
								'</label>' +
								'<div class="progress progress-small">' +
									'<div class="progress-bar progress" style="width:' + row['relationship.contactperson._howgoing'] + '%;"' +
										' role="progressbar" aria-valuenow="' + row['relationship.contactperson._howgoing'] + '" aria-valuemin="0" aria-valuemax="100"></div>' +
								'</div>' +
							'</div>'
					}
			...
			connectionsView.render('#learning-partner-connections-view');
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show',
	code: function (param, response)
	{
		//var otherContactPersonGUID = app._util.param.get(param.dataContext, 'guid').value;
		//app.invoke('learning-partner-connections-dashboard-show-level-up-profile', param);

		//Do on expand
		app.invoke('learning-partner-connections-dashboard-show-projects', param);
		//app.invoke('learning-partner-connections-dashboard-show-reflections', param);
		//app.invoke('learning-partner-connections-dashboard-show-skills', param);
		//app.invoke('learning-partner-connections-dashboard-show-endorsements', param);
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-endorsements',
	code: function (param, response)
	{
		var otherContactPersonGUID = app._util.param.get(param.dataContext, 'guid').value;
		...
		if (response == undefined)
		{
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard-show-endorsements',
				callbackParam: param
			});
		}
		else
		{
			var connectionsDashboardView = app.vq.init({queue: 'learning-partner-connections-dashboard-show'});
			...
			connectionsDashboardView.add(
			[
			  '<button type="button" class="btn btn-sm btn-white mb-2 myds-navigate" data-controller="learning-partner-connections-endorsements"',
			...
			connectionsDashboardView.render('#learning-partner-connections-dashboard-view-' + otherContactPersonGUID + '-endorsements');
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-reflections',
	code: function (param, response)
	{
		var otherContactPersonGUID = app._util.param.get(param.dataContext, 'guid').value;
		...
		if (response == undefined)
		{
			...
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard-show-reflections',
				callbackParam: param
			});
		}
		else
		{
			var connectionsDashboardReflectionsView = app.vq.init({queue: 'learning-partner-connections-dashboard-show-reflections'});
			...
			else
			{
				...
				_.each(response.data.rows, function (row)
				{
					row.attributes = app.invoke('learning-partner-connections-dashboard-show-reflections-attributes', param, row);
			...
			connectionsDashboardReflectionsView.add(
			[
				  '<button type="button" class="d-none btn btn-sm btn-white mb-2 myds-navigate" data-controller="learning-partner-connections-reflections">',
				  		'Add',
              '</button>'
			]);
                                                  
			connectionsDashboardReflectionsView.render('#learning-partner-connections-dashboard-view-' + otherContactPersonGUID + '-reflections');
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-reflections-attributes',
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-skills',
	code: function (param, response)
	{
		var otherContactPersonGUID = app._util.param.get(param.dataContext, 'guid').value;
		...
		if (response == undefined)
		{
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard-show-skills',
				callbackParam: param
			});
		}
		else
		{
			var connectionsDashboardSkillsView = app.vq.init({queue: 'learning-partner-connections-dashboard-show-skills'});
			...
			connectionsDashboardSkillsView.add(
			[
				  '<button type="button" class="d-none btn btn-sm btn-white mb-2 myds-navigate" data-controller="learning-partner-connections-achievements">',
				  		'Add',
              '</button>'
			]);
                                                  
			connectionsDashboardSkillsView.render('#learning-partner-connections-dashboard-view-' + otherContactPersonGUID + '-skills');
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-projects',
	code: function (param, response)
	{
		if (param.status == 'shown')
		{
			...
			if (response == undefined)
			{
				entityos.cloud.search(
				{
					...
					callback: 'learning-partner-connections-dashboard-show-projects',
					callbackParam: param
				});
			}
			else
			{
				...
				var connectionsDashboardProjectsView = app.vq.init({queue: 'learning-partner-connections-dashboard-show-projects'});
				...
				else
				{
					...
					[
						'<li class="mb-2">',
						'<div><a href="#{{url}}/{{projectteam.project.guid}}">{{projectteam.project.description}}</a></div>',
						'</li>'
					]);
				...
				*/
				...
				connectionsDashboardProjectsView.render('#learning-partner-connections-dashboard-view-' + otherContactPersonGUID + '-projects');
			}
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-level-up-profile',
	code: function (param, response)
	{
		var otherContactPersonGUID = app._util.param.get(param.dataContext, 'guid').value;
		...
		if (response == undefined)
		{
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard-show-level-up-profile',
				callbackParam: param
			});
		}
		else
		{
			...
			//{
				app.invoke('learning-partner-connections-dashboard-show-level-up-profile-show',
				{
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-level-up-profile-show',
	code: function (param, response)
	{
		...
		if (_.isSet(levelUpProfileProject))
		{
			if (response == undefined)
			{
				entityos.cloud.search(
				{
					...
					callback: 'learning-partner-connections-dashboard-show-level-up-profile-show',
					callbackParam: param
				});
			}
			else
			{
				...
				app.invoke('learning-partner-connections-dashboard-show-level-up-profile-show-render', param);
			}
		}
		else
		{
...
app.add(
{
	name: 'learning-partner-connections-dashboard-show-level-up-profile-show-render',
	code: function (param, response)
	{
		var levelUpProfileProject = app._util.param.get(param, 'levelUpProfileProject').value;
		...
		{
			queue: 'learning-partner-connections-dashboard-show-projects-level-up-profile'
		});
		...
		connectionsDashboardLevelUpProfileView.render('#learning-partner-connections-dashboard-view-' + otherContactPersonGUID + '-levelup-profile');
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-verify',
	code: function (param, response)
	{
		var data = app.get(
		{
			scope: 'learning-partner-connections-dashboard-learning-verify',
			valueDefault: {}
		});
		...
		if (response == undefined)
		{
			...
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard-learning-verify',
				callbackParam: param
			})
		}
		else
		{
							...
							'<div class="card-body pt-3 pb-3">',
								'<div class="row mr-0">',
									...
									'<div class="col-2 text-right pr-0">',
										'<a class="btn btn-link btn-sm text-muted myds-collapse-toggle"',
											' data-toggle="collapse" role="button"',
											' href="#learning-partner-connections-dashboard-learning-verify-collapse-{{relationship.contactperson.guid}}"',
										'>',
											'<i class="fa fa-chevron-down text-muted"></i>',
										'</a>',
									'</div>',
								'</div>',
							'</div>',
							'<div class="collapse myds-collapse" id="learning-partner-connections-dashboard-learning-verify-collapse-{{relationship.contactperson.guid}}"',
								' data-controller="learning-partner-connections-dashboard-learning-verify-show"',
								' data-guid="{{relationship.contactperson.guid}}"',
								' data-id="{{relationship.contactperson.id}}">',
									...
									'<div class="row mr-0">',
										'<div class="col-12">',
											'<ul class="nav nav-tabs myds-tab">',
												'<li class="nav-item">',
													'<a class="nav-link active" data-toggle="tab"',
														' href="#learning-partner-connections-dashboard-learning-verify-show-{{relationship.contactperson.guid}}-tasks"',
														' data-guid="{{relationship.contactperson.guid}}"',
														' data-controller="learning-partner-connections-dashboard-learning-verify-show-tasks">',
														'<i class="fe fe-square" style="color: #f66c1d !important;"></i> Verify Learning',
													'</a>',
												'</li>',
												'<li class="nav-item">',
													'<a class="nav-link" data-toggle="tab" ',
														' href="#learning-partner-connections-dashboard-learning-verify-show-{{relationship.contactperson.guid}}-tasks-verified"',
														' data-guid="{{relationship.contactperson.guid}}"',
														' data-context="verified"',
														' data-controller="learning-partner-connections-dashboard-learning-verify-show-tasks">',
														'<i class="fe fe-check-square" style="color: #28a745 !important;"></i> Verified Learning <span class="text-muted">(Create Achievements)</span>',
													'</a>',
												'</li>',
											'</ul>',
											'<div class="tab-content">',
												'<div class="tab-pane active pt-2" id="learning-partner-connections-dashboard-learning-verify-show-{{relationship.contactperson.guid}}-tasks">',
													'<div class="text-secondary mt-2 mb-0">',
														'Learning & Project Tasks completed by {{relationship.contactperson.firstname}} that are ready for verification.',
													'</div>',
													'<div class="mt-4" id="learning-partner-connections-dashboard-learning-verify-show-{{relationship.contactperson.guid}}-tasks-view">',
													'</div>',
												'</div>',
												'<div class="tab-pane pt-2" id="learning-partner-connections-dashboard-learning-verify-show-{{relationship.contactperson.guid}}-tasks-verified">',
													'<div class="text-secondary mt-2 mb-0">',
														'Learning & Project Tasks verified for {{relationship.contactperson.firstname}}.',
													'</div>',
													'<div class="mt-4" id="learning-partner-connections-dashboard-learning-verify-show-{{relationship.contactperson.guid}}-tasks-verified-view">',
													'</div>',
												'</div>',
			...
			connectionsView.render('#learning-partner-connections-learning-verify-view');

			//app.invoke('learning-partner-connections-dashboard-learning-verify-show', param);
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-verify-show',
	code: function (param, response)
	{
		//var otherContactPersonGUID = app._util.param.get(param.dataContext, 'guid').value;
		app.invoke('learning-partner-connections-dashboard-learning-verify-show-tasks', param);
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-verify-show-tasks',
	code: function (param, response)
	{
		var otherContactPersonGUID = app._util.param.get(param.dataContext, 'otherContactPersonGuid').value;
		if (_.isNotSet(otherContactPersonGUID))
		{
			otherContactPersonGUID = app._util.param.get(param.dataContext, 'guid').value;
		}
		...
		var data = app.get(
		{
			scope: 'learning-partner-connections-dashboard-learning-verify-show-tasks',
			valueDefault: {}
		});
		...
		if (response == undefined)
		{
			...
			entityos.cloud.search(
			{
				...
				[
					...
					'projecttask.taskbyuser.contactperson.id',
					'modifieddate',
					'percentagecomplete',
					'statustext',
					'startdate',
				...
				rows: 999,
				callback: 'learning-partner-connections-dashboard-learning-verify-show-tasks',
				callbackParam: param
			})
		}
		else
		{
			...
			app.invoke('learning-partner-connections-dashboard-learning-verify-show-tasks-actions', param);
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-verify-show-tasks-actions',
	code: function (param, response)
	{
		let context = app._util.param.get(param.dataContext, 'context').value;
			...
			if (data['project-tasks'].length == 0)
			{
					...
					[
						'<div class="alert alert-info shadow">',
							'<div class="col-12 mt-1 pl-1">',
								'<h3 class="mb-2">There are no tasks that have been verified.</h3>',
								'<div>Suggest checking the "Verify Learning" tab.</div>',
							'</div>',
						'</div>'
					]);
				}
				else
				{
					...
					[
						'<div class="alert alert-info shadow">',
							'<div class="col-12 mt-1 pl-1">',
								'<h3 class="mb-2">There are no tasks that need verification.</h3>',
								'<div>Some tasks are auto-verified, so suggest checking the "Verified Learning" tab.</div>',
							'</div>',
						'</div>'
					]);
				}

				feedView.render('#learning-partner-connections-dashboard-learning-verify-show-' + otherContactPersonGUID + '-tasks-' + viewContext + 'view')
			}
			else
			{
				const filters =
				[
					...
					},
					{
						field: 'objectcontext',
						comparison: 'IN_LIST',
						value: _.map(data['project-tasks'], 'project')
					}
				];
				...
				entityos.cloud.search(
				{
					...
					filters: filters,
					rows: 999,
					callback: 'learning-partner-connections-dashboard-learning-verify-show-tasks-actions',
					callbackParam: param
				})
			}
		}
		else
		{
			...
			app.invoke('learning-partner-connections-dashboard-learning-verify-show-tasks-show', param);
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-verify-show-tasks-show',
	code: function (param, response)
	{
		{
			let context = app._util.param.get(param.dataContext, 'context').value;
			...
			else 
			{
				...
				let projectTasksByProject = _.groupBy(projectTasks, 'projecttask.project.guid');
				...
				_.each(projectTasksByProject, function (projectTasks, projectGUID)
				{
					const project = _.first(projectTasks);

					project._action = _.find(data['actions'], function (action)
					{
						return (action.objectcontext == project.project);
					})

					project._actionbutton = '';

					if (_.isUndefined(project._action))
					{
						project._actionbutton = _.join(
						[
							'<div class="col-auto">',
								'<button type="button" class="btn btn-sm btn-default btn-outline myds-click"',
									' data-controller="learning-partner-connections-dashboard-learning-verify-task-save"',
									' data-id="', project['id'], '"',
									' data-context="', context, '"',
									' data-other-contact-person-guid="', otherContactPersonGUID, '"',
									' data-guid="', projectGUID, '">',
					...
					let projectTitle = project['projecttask.project.title'];
					if (projectTitle == '')
					{
						projectTitle = project['projecttask.project.description'];
					}
					...
					[
						'<div class="row mt-3">',
							'<div class="col">',
								'<h2 class="mb-2 text-info">', projectTitle, '</h2>',
							'</div>'
					])
						...
						if (_.isUndefined(project._action))
						{
							...
							[
								'<div class="col-auto">',
									'<button type="button" class="btn btn-sm btn-default btn-outline myds-click"',
										' data-spinner="append"',
										' data-controller="learning-partner-connections-dashboard-learning-verify-create-achievement"',
										' data-id="', project['projecttask.project.id'], '"',
										' data-project="', project['projecttask.project.id'], '"',
										' data-context="', context, '"',
										' data-contactperson="', project['projecttask.taskbyuser.contactperson.id'], '"',
										' data-guid="', project['projecttask.project.guid'], '">',
											'Create Achievement',
										'</button>',
								'</div>'
							]);
					...
					_.each(projectTasks, function (task)
					{
						task.initials = _.first(task['projecttask.taskbyuser.contactperson.firstname']) +
											_.first(task['projecttask.taskbyuser.contactperson.surname']);

						task._actionbutton = project._actionbutton;

						if (_.startsWith(task.notes, '{'))
						{
							task._notes = JSON.parse(task.notes);
							task.notes = '<ul>' + _.join(_.map(task._notes.reflections, function (reflection)
							{
						...
						feedView.add({useTemplate: true,}, task)
					});
				});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-verify-task-save',
	code: function (param, response)
	{	
		...
		if (response == undefined)
		{
			...
			entityos.cloud.save(
			{
				object: 'project_task',
				data: data,
				callback: 'learning-partner-connections-dashboard-learning-verify-task-save',
				callbackParam: param
			});
		}
		else
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-verify-create-achievement',
	code: function (param)
	{		
		app.invoke('util-project-achievement-create', param.dataContext)
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learning-partners',
	...
	code: function (param, response)
	{
		...
		if (response == undefined)
		{
			...
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard-learning-partners'
			})
		}
		else
		{
			...
			connectionsView.render('#learning-partner-connections-dashboard-learning-partners-view');
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learners-init',
	notes: 'Show LP Code',
	code: function (param, response)
	{	
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learners-signup',
	...
	{	
		if (response == undefined)
		{
			entityos.cloud.search(
			{
				...
				callback: 'learning-partner-connections-dashboard-learners-signup'
			});
		}
		else
		{
			app.set(
			{
				scope: 'learning-partner-connections-dashboard-learners-signup-learner',
			...
			app.invoke('learning-partner-connections-dashboard-learners-signup-process')
		}
	}
});
...
app.add(
{
	name: 'learning-partner-connections-dashboard-learners-signup-process',
	code: function (param)
	{	
		...
		linkView.render('#learning-partner-connections-dashboard-learners-signup-view' + linkContext)
	}
});
