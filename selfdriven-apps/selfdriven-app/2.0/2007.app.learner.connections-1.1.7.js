...
app.add(
{
	...
	{		
		...
		else
		{
			...
			typesView.add(
			[
				'<button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown" id="learner-teams-types-filter" aria-expanded="false">',
	...
	code: function (param, response)
	{
		...
		else
		{
			...
			if (response.data.rows.length == 0)
			{
				...
				[
					'<ul class="list-group mb-2 ml-4 mt-3">',
						'<li class="mb-2 text-muted font-italic">No endorsements at this moment.</li>',
					'</ul>'
				]);
			}
			else
	...
	code: function (param, response)
	{
		...
		else
		{
			...
			if (response.data.rows.length == 0)
			{
				...
				[
					'<ul class="list-group mb-2 ml-4 mt-3">',
						'<li class="mb-2 text-muted font-italic">No reflections at this moment.</li>',
					'</ul>'
				]);
			}
			else
	...
	code: function (param, response)
	{
		...
		else
		{
			...
			if (response.data.rows.length == 0)
			{
				...
				[
					'<ul class="list-group mb-2 ml-4 mt-3">',
						'<li class="mb-2 text-muted font-italic">No registered achievements at this moment.</li>',
					'</ul>'
				]);
			}
			else
