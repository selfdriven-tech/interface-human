	...
	code: function (param)
	{
		...
		[
			'<div class="mt-4 pt-3 pb-1 w-md-75 mx-auto">',
				'<div class="row">',
					'<div class="col-1 text-right pr-3" style="padding-top:4px;">',
						'<a class="entityos-click"',
							' data-spinner',
							' data-controller="selfdriven-ai-get-models"',
						'>',
						'<img src="/site/2134/selfdriven-art-series-3-octo.0.doing.stuff-thanks.png" class="img-responsive mx-auto rounded-circle" style="height:40px; padding-top: 2px;">',
						'</a>',
					'</div>',
					'<div class="col-10 px-0">',
						'<form autocomplete="off">',
							'<div class="input-group input-group-flush input-group-merge input-group-reverse">',
							'<textarea class="form-control input-lg entityos-text text-center input-rounded" id="selfdriven-ai-chat-text" placeholder="Chat with Octo" data-enterx="stop" data-clean="disabled" data-scope="selfdriven-ai" data-context="chat-text" rows="1" style="resize: none; overflow: hidden; min-height: 48px; max-height: 160px; border-radius: 24px; padding: 12px 20px; background-color: #f9f9f9;"></textarea>',
							'</div>',
						'</form>',
					'</div>',
					'<div class="col-1 pl-0 mt-1">',
						'<button class="btn btn-success rounded-pill entityos-click" style="height:40px;"',
				...
				'<div class="row">',
					'<div class="col-12">',
						'<input type="file" id="selfdriven-ai-attach-file" class="entityos-change" data-controller="selfdriven-ai-attach-select" data-context="file" style="display:none;"/>',
			...
			'<div id="selfdriven-ai-chat-view">',
				'<div class="row">',
					'<div class="col-12 mt-2">',
						...
						'>I\'m Bored</button>',
						'<button class="btn btn-default border btn-sm entityos-click rounded-pill ml-2"',
							' data-spinner',
							' data-controller="selfdriven-ai-chat" data-text="I\'m Curious"',
						'>I\'m Curious</button>',
					'</div>',
				'</div>',
			'</div>'
		...
		chatDashboardView.add(
		[
			'<div id="selfdriven-ai-attach-file-view"">',
			'</div>'
		]);
		...
		$('#selfdriven-ai-chat-text').on('input', function () {
...
app.add(
{
	name: 'selfdriven-ai-attach-select',
	code: function (param)
	{
		console.log(param)
		...
		{
			app.invoke('selfdriven-ai-chat-attach-file-to-base64', attachFile).then(function (dataBase64)
			{
				...
				attachSelectView.render('#selfdriven-ai-attach-file-view');
			});
		}
		else
		{
...
app.add(
{
	name: 'selfdriven-ai-chat-attach-file-to-base64',
	code: function (file)
	{
					...
					[
						'<div class="row items-align-end">',
							'<div class="col', (model.default?' text-dark':' text-secondary'), ' entityos-click"',
								' data-controller="selfdriven-ai-get-models-set"',
...
app.add(
{
	name: 'selfdriven-ai-get-models-set',
	code: function (param)
	{
		//console.log(param)
