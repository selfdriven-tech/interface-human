...
app.add(
{
	...
	code: function (param, response)
	{
		...
		if (response == undefined)
		{
			...
			if (whoami != undefined)
			{
				app.invoke('learner-me-dashboard-projects');
			}
			else
			{
...
app.add(
{
	name: 'learner-me-dashboard-projects',
	code: function (param, response)
	{
		var whoami = app.get(
		{
		...
		{	
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-dashboard-projects'
			});
		}
		else
		{
...
app.add(
{
	...
	{	
		...
		{
			scope: 'learner-me-summary-attributes',
			context: 'category',
			valueDefault: 'general',
			set: true
		});

		app.invoke('util-view-button-set-active', {selector: '#learner-me-attributes-' + attributesCategory});

		app.invoke('learner-me-identifiers');
		
		app.invoke('learner-me-summary-learning-partners');
		app.invoke('learner-me-summary-attributes');
		app.invoke('learner-me-summary-skills');
		app.invoke('learner-me-summary-endorsements');
		
		app.invoke('learner-me-summary-tokens');
	}	
});

app.add(
{
	name: 'learner-me-identifiers',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-identifiers',
				set:
				{
					scope: 'learner-me',
					context: 'identifiers'
		...
		else
		{
			...
			{
				var identifiersView = app.vq.init({queue: 'learner-me-summary-identifiers'});
				...
				identifiersView.render('#learner-me-summary-identifiers-view');
			}
		}
	}
});
...
app.add(
{
	name: 'learner-me-summary-attributes',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
      ...
      app.vq.render('#learner-me-summary-attributes-view')	
	}
});

app.add(
{
	name: 'learner-me-summary-skills',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-summary-skills',
				set:
				{
					scope: 'learner-me',
					context: 'skills'
		...
		else
		{
			...
			var skillsView = app.vq.init({queue: 'learner-me-summary-skills'});
			...
			else
			{
	      	...
	      	skillsView.render('#learner-me-summary-skills-view');
			...
			_.each(whoamiContractAttributes, function (whoamiContractAttribute)
			{
				if (whoamiContractAttribute.url == '00010000230000')
				{
					...
					{
						$('#learner-me-summary-' + whoamiContractAttribute.url + '-view').html(_whoamiContractAttributeSkill.notes)
					}
				}
			});
	   }
...
app.add(
{
	name: 'learner-me-summary-endorsements',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-summary-endorsements',
				set:
				{
					scope: 'learner-me',
		...
		else
		{
			...
			var endorsementsView = app.vq.init({queue: 'learner-me-summary-endorsements'});
	      ...
	      endorsementsView.render('#learner-me-summary-endorsements-view')	
	   }
	}
});
...
app.add(
{
	name: 'learner-me-summary-tokens',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-summary-tokens'
			});
		}
		else
		{
			...
			var tokensSummaryView = app.vq.init({queue: 'learner-me-summary-tokens'});
			...
			else
			{
				...
				[
					...
					'<h1 class="p-0 mb-2" style="font-size:3em;"><a href="#learner-tokens-" id="learner-me-summary-tokens-total-community" style="color:#9ecbed;">',
			...
			tokensSummaryView.render('#learner-me-summary-tokens-view')	
		}
	}
});
...
app.add(
{
	name: 'learner-me-summary-learning-partners',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-summary-learning-partners',
				set:
				{
					scope: 'learner-me',
		...
		else
		{
			...
			var learningPartnersView = app.vq.init({queue: 'learner-me-summary-learning-partners'});
	      ...
	      learningPartnersView.render('#learner-me-summary-learning-partners-view')	
	   }
	}
});
...
app.add(
{
	...
	{	
		...
		app.view.refresh(
		{
			scope: 'learner-me-edit',
			selector: '#learner-me-edit',
			data: data
		});
		...
		if (attributesCategory == undefined)
		{
			app.set(
			{
				scope: 'learner-me-edit-attributes',
				context: 'category',
		...
		_.each(whoamiContractAttributes, function (whoamiContractAttribute)
		{
			...
			if (_.isSet(_whoamiContractAttributeSkill))
			{
				$('#learner-me-edit-attribute-note-' + whoamiContractAttribute.url).val(_whoamiContractAttributeSkill.notes)
			}
		});

		app.invoke('learner-me-edit-attributes');
	}	
});

app.add(
{
	name: 'learner-me-edit-attributes',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		[
			'<div class="form-group">',
           	'<label class="form-check-label mb-1" for="learner-me-edit-attributes-{{meid}}">',
            	'<div>{{title}}</div>',
             	'<div class="text-muted small">{{caption}}</div>',
           	'</label>',
           	'<input type="range" min="0" max="100" value="{{value}}" step="10" class="form-range entityos-range"',
           		' data-scope="learner-me-edit-{{meid}}"',
           		' data-context="{{alias}}"',
           		' id="learner-me-edit-attributes-{{id}}-{{meid}}">',
         '</div>'
		],
      {
      	type: 'template'
      ...
      app.vq.render('#learner-me-edit-attributes-view')
	}
});

app.add(
{
	name: 'learner-me-edit-image-upload',
	code: function (param)
	{	
		mydigitalstructure._util.attachment.upload(
		{
		  context: 'myds-util-attachment-upload-image',
		  callback: 'learner-me-edit-image-upload-process'
		});
	}
});
...
app.add(
{
	name: 'learner-me-edit-image-upload-process',
	code: function (param, response)
	{
		var whoami = app.get(
		{
		...
		else
		{
			...
			app.invoke('util-view-spinner-remove', {controller: 'learner-me-edit-image-upload'});
		}
	}
});
...
app.add(
{
	...
	{	
		...
		var data = app.get(
		{
			scope: 'learner-me-edit-' + whoami.id,
		...
		{	
			if (response.status == 'OK')
			{
				app.invoke('learner-me-edit-attributes-save');
				app.invoke('learner-me-edit-action-save')
				app.notify('Profile updated.');
				app.invoke('app-navigate-to', {controller: 'learner-me'});
			}
		}
	}
});
...
app.add(
{
	name: 'learner-me-edit-attributes-save',
	code: function (param, response)
	{	
		...
		{
			scope: 'learner-me-edit-attributes-' + whoami.id,
			cleanForCloudStorage: true,
			valueDefault: {}
		});
...
app.add(
{
	name: 'learner-me-edit-action-save',
	code: function (param, response)
	{	
...
app.add(
{
	...
	{	
		...
		app.view.refresh(
		{
			scope: 'learner-me-edit-on-chain',
			selector: '#learner-me-edit-on-chain',
			data: data
		});
	}	
});
...
app.add(
{
	name: 'learner-me-security-setup-2ndfactor-show',
	code: function (param, response)
	{
		let setup2ndFactorView = app.vq.init({queue: 'learner-me-history'});
			...
			'<div class="mt-2">',
				...
				'<div class="mt-2">',
					'<button class="btn btn-default btn-outline mx-auto btn-block btn-sm myds-click mt-3 mb-3"',
							' data-controller="learner-me-security-setup-2ndfactor"',
							' id="learner-me-summary-security-setup-2ndfactor-{{id}}" data-context="{{id}}"',
							' data-id="{{id}}">',
		...
		setup2ndFactorView.render('#learner-me-summary-security-2ndfactor-view');
	}
})

app.add(
{
	name: 'learner-me-security-setup-2ndfactor',
	code: function (param, response)
	{	
		...
		app.invoke('util-security-totp-init',
		{
			id: user.id,
			user: user,
			selector: '#learner-me-summary-security-2ndfactor-view',
...
app.add(
{
	name: 'learner-me-security-setup-passkey',
	code: function (param, response)
	{	
		//var user = app.whoami().thisInstanceOfMe.user;

		// util-security-webauthn-init @ entityos.util.security-1.1.16.js^
		//app.invoke('util-security-webauthn-init')

		//util-webauthn-create-passkey @ selfdriven.util.identity.webauthn-3.0.0.js^
		app.invoke('util-identity-webauthn-passkey-create',
		{
			selector: '#learner-me-summary-security-passkey-view',
			text: ''
		});
	}	
});
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		if (response == undefined)
		{
			app.view.clear('#learner-me-history-view');
			app.view.clear('#learner-me-history-attributes-view');
		...
		else
		{
			if (response.status == 'OK')
			{
				...
				if (response.data.rows.length != 0)
				{
					app.invoke('learner-me-history-attributes')
				}
			}
		}
	}
...
app.add(
{
	name: 'learner-me-history-attributes',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		learnerMeHistoryDatesView = app.vq.init({queue: 'learner-me-history-dates'});
		...
		learnerMeHistoryDatesView.render('#learner-me-history-dates-view');
      ...
      app.vq.render('#learner-me-history-attributes-view')	
	}
});
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		if (response == undefined)
		{
			...
			app.set(
			{
				scope: 'learner-me-visual',
				context: 'category',
				value: attributesCategory
			});
		
			app.invoke('util-view-button-set-active', {selector: '#learner-me-visual-for-' + attributesCategory});
 
			app.view.clear('#learner-me-visual-view');
			app.view.clear('#learner-me-visual-attributes-view');
		...
		else
		{
			...
			if (response.status == 'OK')
			{
				...
				learnerMeVisualDatesView.render('#learner-me-visual-dates-count-view');

				//if (attributes.length != 0)
				//{
					app.invoke('learner-me-visual-refresh')
				//}
			}
		}
	}
...
app.add(
{
	name: 'learner-me-visual-refresh',
	code: function (param, response)
	{	
		...
		{
			app.invoke('learner-me-visual-attributes')
		}

		if (perspective == 'balance')
		{
			app.invoke('learner-me-visual-attributes-balance')
		}

		if (perspective == 'balance-growth')
		{
			app.invoke('learner-me-visual-attributes-growth')
		}

		if (perspective == 'balance-radar')
		{
			app.invoke('learner-me-visual-attributes-balance-radar')
		}
	}
});
...
app.add(
{
	name: 'learner-me-visual-attributes',
	code: function (param, response)
	{	
		app.set(
		{
		...
		learnerMeVisualDatesView = app.vq.init({queue: 'learner-me-visual-dates'});
		...
		learnerMeVisualDatesView.render('#learner-me-visual-dates-view');
	}
});

app.add(
{
	name: 'learner-me-visual-attributes-balance',
	code: function (param, response)
	{	
		app.set(
		{
		...
		if (response == undefined)
		{
			...
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-visual-attributes-balance',
				callbackParam: param
			});
		}
		else
...
app.add(
{
	name: 'learner-me-visual-attributes-growth',
	code: function (param, response)
	{	
		app.set(
		{
...
app.add(
{
	name: 'learner-me-visual-attributes-balance-radar',
	code: function (param, response)
	{	
		app.set(
		{
