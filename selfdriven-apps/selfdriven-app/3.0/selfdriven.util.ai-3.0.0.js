				...
				'<div class="row">',
					'<div class="col-12 mt-2">',
						...
						'<button class="btn btn-default border btn-sm entityos-click rounded-pill ms-2"',
							' data-spinner',
							' data-controller="util-ai-chat-send" data-text="I need an idea for my level up profile"',
						'>I need an idea for my level up profile</button>',
					'</div>',
				'</div>',
			'</div>'
		]);
