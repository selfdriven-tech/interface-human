/*
	uses
		- https://github.com/ibcom-lab/entityos-identity-trust
	...
	setup
		...
		- url
			...
			{
				object: 'core_url',
				fields: ['title', 'internalreference'], filters: {group: [groupid]},
				rows: 99
			});
		...
		- user
			use the entityOS default WebAuthn trusted user

		- site
			- Add IdentityProviderURL: https://identity.api.entityos.cloud
