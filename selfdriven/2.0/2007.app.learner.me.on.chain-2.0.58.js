	...
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'learner-me-on-chain-edit'
			});
		}
		else
		{
			...
			app.set(
			{
				scope: 'learner-me-on-chain-summary',
				context: 'dataContext',
				value: data
			});
			...
			app.view.refresh(
			{
				scope: 'learner-me-on-chain-edit',
				selector: '#learner-me-on-chain-edit',
				data: data
			});
		}		
	}	
...
app.add(
{
	name: 'learner-me-on-chain-edit-save',
	code: function (param, response)
	{	
		var data = app.get(
		{
			scope: 'learner-me-on-chain-edit-' + app.whoami().thisInstanceOfMe.user.id,
		...
		if (_.isSet(data['cardano-primary-address']))
		{
			if (_.isUndefined(response))
			{
				...
				mydigitalstructure.cloud.save(
				{
					object: 'core_protect_key',
					data: saveData,
					callback: 'learner-me-on-chain-edit-save'
				});
			}
			else
			{	
