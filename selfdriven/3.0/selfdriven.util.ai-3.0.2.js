					...
					'<div class="">',
						'<div class="row">',
							'<div class="col-1 text-right pr-3">',
								...
								'>',
								'<img src="/site/2134/artomics-s…-1-octo.0.importance-of-understanding-of-self.png" class="img-responsive mx-auto rounded-circle" style="height:42px; padding-top: 2px;">',
								'</a>',
							'</div>',
							'<div class="col-10 px-0">',
								'<form autocomplete="off">',
									'<div class="input-group input-group-flush input-group-merge input-group-reverse">',
										'<input type="text" class="form-control input-lg entityos-text text-center input-rounded" data-enter="stop" data-clean="disabled" data-scope="util-ai" data-context="chat-assistant-text" id="util-ai-chat-assistant-text" placeholder="Chat with Assistant">',
									'</div>',
								'</form>',
							'</div>',
							'<div class="col-1 pl-2 mt-0">',
