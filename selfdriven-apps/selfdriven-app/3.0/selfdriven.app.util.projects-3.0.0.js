					...
					format:
					{
						...
						row:
						{
							...
							method: function (row)
							{
								...
								row.subjectInfo = '';
								let subjectInfoClass = '';

								if (row.title != '')
								{
									row.subjectInfo = row.subjectInfo +
										'<div>' + row.title + '</div>';

									subjectInfoClass = 'mt-1 text-secondary'
								}

								if (row.description != '')
								{
									row.subjectInfo = row.subjectInfo +
										'<div class="' + subjectInfoClass + '">' + row.description + '</div>';
								}
						...
						[
							{
								...
								sortBy: true,
								defaultSort: true,
								class: 'col-6 col-sm-7 text-break text-wrap myds-navigate',
							...
							},
							{
								fields:
								[
									'title', 'description', 'project', 'projecttask.project.description',
