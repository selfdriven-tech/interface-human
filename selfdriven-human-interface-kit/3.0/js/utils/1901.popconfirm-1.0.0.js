  ...
  $.fn.extend({
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        {
          options['parentid'] = $(this).attr('data-parent-id')
        }
