...
app.add(
{
	...
	code: function (param, response)
	{
		...
		var id = app._util.param.get(param, 'id', {default: 'project'}).value;

		if (id == 'project')
		{
			app.invoke('util-view-tab-show', '#learner-projects-dashboard-project');
		}
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		var viewType = app._util.param.get(data.dataContext, 'type', {default: 'project'}).value;
		...
		*/
		...
		if (viewType == 'project') // PROJECTS
		{
			viewContainer = 'learner-projects-dashboard-view-project-container';
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		else
		{
			...
			var navigationController = 'learner-project-do';
			...
			if (response.data.rows.length == 0)
			{
				...
				[
					'<div class="text-muted text-center">',
						'You do not have any projects that match this search.',
					'</div>'
				]);
			}
			else 
...
app.add(
{
	...
	{	
        ...
        var projectTemplates = app.get
        (
            {
                scope: 'learner-projects-templates'
            }
        )

        if (projectTemplates.uriContext == 'learning')
        {
