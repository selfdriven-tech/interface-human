	...
	code: function (param, onChainData)
	{
		...
		if (_.has(onChainData, 'address.amount'))
		{
			if (onChainData.address.amount != undefined)
			{
				_.each(onChainData.address.amount, function (amount)
				{
					...
					if (_.startsWith(amount.unit, '11d09f751a005b90b56ccaad3f7a4d2c90bef0f106c4d1c66f61c2ca'))
					{
						amount._unit = amount.unit;
						amount.unit = 'OctoProto';
						amount.imagesrc = '/site/2007/octoproto.png';
						amount.unithref = '<a href="https://octomics.io" target="_blank">' +
												'OctoProto</a>';
						amount.imageheight = '120px'
					}
		...
		if (_.has(onChainData, 'account'))
		{
			_.each(onChainData.account, function (account)
			{
				...
				if (_.startsWith(account.unit, '11d09f751a005b90b56ccaad3f7a4d2c90bef0f106c4d1c66f61c2ca'))
				{
					account._unit = account.unit;
					account.unit = 'OctoProto';
					account.imagesrc = '/site/2007/octoproto.png';
					account.unithref = '<a href="https://octomics.io" target="_blank">' +
											'OctoProto</a>';
					account.imageheight = '120px'
				}
