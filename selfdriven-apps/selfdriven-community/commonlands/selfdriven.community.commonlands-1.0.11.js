	...
	{	
		...
		else
		{
			...
			else
			{
				...
				messageView.add(
				[
					'<h4 class="mt-3 pb-3 text-white"><i class="fa fa-exclamation-triangle text-warning mr-2"></i>There was an issue signing you up, please contact Commonlands support.</h4>',
					'<div class="mt-1 text-white"><a href="mailto:connect@commonlands.org">connect@commonlands.org</a></div>'
				]);
