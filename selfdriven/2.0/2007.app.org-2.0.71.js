...
var app =
{
	build:
	{
		name: 'selfdriven Org',
		version: '2.0.71',
		description: "selfdriven Org App",
		...
		[
			{
				...
				{
					name: 'app',
					url: '/site/2179/2007.style.org.light-2.0.71.css'
				}],
				default: true,
				type: 'light'
			},
			{
				...
				{
					name: 'app',
					url: '/site/2129/2007.style.org.dark-2.0.71.css'
				}],
				default: true,
				type: 'dark' 
			}
