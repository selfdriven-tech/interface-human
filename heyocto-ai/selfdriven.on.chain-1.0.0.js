...
[
	...
	},
	{
		...
		code: function (param)
		{
			...
			// SET THIS IN THE ai specific js
			/*const onChainAuth = eos.set(
			{
			...
			//make this chat 'auth.container' option
			onChainWalletAssetsView.add('<div id="on-chain-dashboard-view"></div>');

			onChainWalletAssetsView.render('#on-chain-view');

			eos.invoke('chat-dashboard-show')
		}
	},
	{
