...
app.add(
{
	...
	code: function (param, response)
	{
		...
		{
			app.view.clear('#uow-passport-me');

			var whoami = app.get(
			{
				scope: 'uow-passport-me',
				context: 'whoami'
			});

			if (whoami != undefined)
			{
				app.invoke('uow-passport-me-dashboard-projects');
			}
			else
			{
...
app.add(
{
	name: 'uow-passport-me-dashboard-projects',
	code: function (param, response)
	{
		var whoami = app.get(
		{
		...
		{	
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-dashboard-projects'
			});
		}
		else
		{
			...
			app.invoke('uow-passport-me-summary');
		}
	}
});
...
app.add(
{
	...
	{	
		...
		app.view.refresh(
		{
			scope: 'uow-passport-me-summary',
			selector: '#uow-passport-me',
			data: whoami
		});

		var attributesCategory = app.get(
		{
			scope: 'uow-passport-me-summary-attributes',
			context: 'category',
			valueDefault: 'general',
			set: true
		});

		app.invoke('util-view-button-set-active', {selector: '#uow-passport-me-attributes-' + attributesCategory});

		app.invoke('uow-passport-me-identifiers');
		
		app.invoke('uow-passport-me-summary-learning-partners');
		app.invoke('uow-passport-me-summary-attributes');
		app.invoke('uow-passport-me-summary-skills');
		app.invoke('uow-passport-me-summary-endorsements');
		
		app.invoke('uow-passport-me-summary-tokens');
	}	
});

app.add(
{
	name: 'uow-passport-me-identifiers',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-identifiers',
				set:
				{
					scope: 'uow-passport-me',
					context: 'identifiers'
		...
		else
		{
			...
			{
				var identifiersView = app.vq.init({queue: 'uow-passport-me-summary-identifiers'});
				...
				identifiersView.render('#uow-passport-me-summary-identifiers-view');
			}
		}
	}
});
	...
	{	
		...
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-teams',
				set:
				{
					scope: 'uow-passport-me',
					context: 'teams'
		...
		else
		{
			...
			app.invoke('uow-passport-me-tasks');
		}
	}
});
		...
		if (response == undefined)
		{
			...
			else
			{
				mydigitalstructure.cloud.search(
				{
					...
					callback: 'uow-passport-me-tasks',
					set:
					{
						scope: 'uow-passport-me',
						context: 'tasks'
			...
			if (response.data.rows.length != 0)
			{
				whoami.tasks = 
					...
					_.join(_.map(response.data.rows, function (row)
							{
								return '<li class="mt-2"><a href="#learner-community-task-summary/' + row['guid'] + '">' + row['description'] + '</a></li>'
...
app.add(
{
	name: 'uow-passport-me-summary-attributes',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		[
			'<div class="mb-3">',
				'<label class="form-check-label mb-0" for="uow-passport-me-edit-attributes-{{meid}}">',
      ...
      app.vq.render('#uow-passport-me-summary-attributes-view')	
	}
});

app.add(
{
	name: 'uow-passport-me-summary-skills',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-summary-skills',
				set:
				{
					scope: 'uow-passport-me',
					context: 'skills'
		...
		else
		{
			...
			var skillsView = app.vq.init({queue: 'uow-passport-me-summary-skills'});
			...
			else
			{
	      	...
	      	skillsView.render('#uow-passport-me-summary-skills-view');
			...
			_.each(whoamiContractAttributes, function (whoamiContractAttribute)
			{
				if (whoamiContractAttribute.url == '00010000230000')
				{
					...
					{
						$('#uow-passport-me-summary-' + whoamiContractAttribute.url + '-view').html(_whoamiContractAttributeSkill.notes)
					}
				}
			});
	   }
...
app.add(
{
	name: 'uow-passport-me-summary-endorsements',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-summary-endorsements',
				set:
				{
					scope: 'uow-passport-me',
		...
		else
		{
			...
			var endorsementsView = app.vq.init({queue: 'uow-passport-me-summary-endorsements'});
	      ...
	      endorsementsView.render('#uow-passport-me-summary-endorsements-view')	
	   }
	}
});
...
app.add(
{
	name: 'uow-passport-me-summary-tokens',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-summary-tokens'
			});
		}
		else
		{
			...
			var tokensSummaryView = app.vq.init({queue: 'uow-passport-me-summary-tokens'});
			...
			else
			{
				...
				[
					...
					'<h1 class="p-0 mb-2" style="font-size:3em;"><a href="#learner-tokens-" id="uow-passport-me-summary-tokens-total-community" style="color:#9ecbed;">',
			...
			tokensSummaryView.render('#uow-passport-me-summary-tokens-view')	
		}
	}
});
...
app.add(
{
	name: 'uow-passport-me-summary-learning-partners',
	code: function (param, response)
	{	
		if (response == undefined)
		{
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-summary-learning-partners',
				set:
				{
					scope: 'uow-passport-me',
		...
		else
		{
			...
			var learningPartnersView = app.vq.init({queue: 'uow-passport-me-summary-learning-partners'});
	      ...
	      learningPartnersView.render('#uow-passport-me-summary-learning-partners-view')	
	   }
	}
});
...
app.add(
{
	...
	{	
		...
		app.view.refresh(
		{
			scope: 'uow-passport-me-edit',
			selector: '#uow-passport-me-edit',
			data: data
		});
		...
		if (attributesCategory == undefined)
		{
			app.set(
			{
				scope: 'uow-passport-me-edit-attributes',
				context: 'category',
		...
		_.each(whoamiContractAttributes, function (whoamiContractAttribute)
		{
			...
			if (_.isSet(_whoamiContractAttributeSkill))
			{
				$('#uow-passport-me-edit-attribute-note-' + whoamiContractAttribute.url).val(_whoamiContractAttributeSkill.notes)
			}
		});

		app.invoke('uow-passport-me-edit-attributes');
	}	
});

app.add(
{
	name: 'uow-passport-me-edit-attributes',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		[
			'<div class="form-group">',
           	'<label class="form-check-label mb-1" for="uow-passport-me-edit-attributes-{{meid}}">',
            	'<div>{{title}}</div>',
             	'<div class="text-muted small">{{caption}}</div>',
           	'</label>',
           	'<input type="range" min="0" max="100" value="{{value}}" step="10" class="form-control-range myds-range"',
           		' data-scope="uow-passport-me-edit-{{meid}}"',
           		' data-context="{{alias}}"',
           		' id="uow-passport-me-edit-attributes-{{id}}-{{meid}}">',
         '</div>'
		],
      {
      	type: 'template'
      ...
      app.vq.render('#uow-passport-me-edit-attributes-view')
	}
});

app.add(
{
	name: 'uow-passport-me-edit-image-upload',
	code: function (param)
	{	
		mydigitalstructure._util.attachment.upload(
		{
		  context: 'myds-util-attachment-upload-image',
		  callback: 'uow-passport-me-edit-image-upload-process'
		});
	}
});
...
app.add(
{
	name: 'uow-passport-me-edit-image-upload-process',
	code: function (param, response)
	{
		var whoami = app.get(
		{
		...
		else
		{
			...
			app.invoke('util-view-spinner-remove', {controller: 'uow-passport-me-edit-image-upload'});
		}
	}
});
...
app.add(
{
	name: 'uow-passport-me-edit-save',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		var data = app.get(
		{
			scope: 'uow-passport-me-edit-' + whoami.id,
		...
		if (_.isUndefined(response))
		{
			mydigitalstructure.update(
			{
				object: 'contact_person',
				data: data,
				callback: 'uow-passport-me-edit-save'
			});
		}
		else
		{	
			if (response.status == 'OK')
			{
				app.invoke('uow-passport-me-edit-attributes-save');
				app.invoke('uow-passport-me-edit-action-save')
				app.notify('Profile updated.');
				app.invoke('app-navigate-to', {controller: 'uow-passport-me'});
			}
		}
	}
});
...
app.add(
{
	...
	{	
		...
		{
			scope: 'uow-passport-me-edit-attributes-' + whoami.id,
			cleanForCloudStorage: true,
			valueDefault: {}
		});
...
app.add(
{
	name: 'uow-passport-me-edit-action-save',
	code: function (param, response)
	{	
...
app.add(
{
	name: 'uow-passport-me-edit-on-chain',
	code: function (param, response)
	{	
		var data = app.get(
		{
		...
		app.view.refresh(
		{
			scope: 'uow-passport-me-edit-on-chain',
			selector: '#uow-passport-me-edit-on-chain',
			data: data
		});
	}	
});
...
app.add(
{
	name: 'uow-passport-me-security-setup-2ndfactor-show',
	code: function (param, response)
	{
		let setup2ndFactorView = app.vq.init({queue: 'uow-passport-me-history'});

		setup2ndFactorView.add(
		[
			'<div class="mt-2">',
				...
				'<div class="mt-2 fw-bold">',
					'Before continuing, make sure you have a "2nd Factor Client"<sup>*</sup> installed. e.g. Authy, Google Authenticator, Microsoft Authenticator or alike.',
				'</div>',
				'<div class="mt-2">',
					'If you continue and are unable to scan the QR code or enter the code, you will be locked out of your account and will need to contact support.',
				'</div>',
				'<div class="mt-2">',
					'<button class="btn btn-default btn-outline mx-auto btn-block btn-sm myds-click mt-3 mb-3"',
							' data-controller="uow-passport-me-security-setup-2ndfactor"',
							' id="uow-passport-me-summary-security-setup-2ndfactor-{{id}}" data-context="{{id}}"',
							' data-id="{{id}}">',
							' <i class="fa fa-check-circle"></i> I have a 2nd Factor Client Set up',
					'</button>',
				'</div>',

				'<div class="mt-1 text-muted small">',
					'<sup>*</sup> "2nd Factor Client" can also be referred to as "MFA Client" or "TOTP Client."',
				'</div>',
			'<div>'
		]);

		setup2ndFactorView.render('#uow-passport-me-summary-security-2ndfactor-view');
	}
})

app.add(
{
	name: 'uow-passport-me-security-setup-2ndfactor',
	code: function (param, response)
	{	
		...
		app.invoke('util-security-totp-init',
		{
			id: user.id,
			user: user,
			selector: '#uow-passport-me-summary-security-2ndfactor-view',
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		if (response == undefined)
		{
			app.view.clear('#uow-passport-me-history-view');
			app.view.clear('#uow-passport-me-history-attributes-view');
			...
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-history'
			});
		}
		else
		{
			if (response.status == 'OK')
			{
				learnerMeHistoryView = app.vq.init({queue: 'uow-passport-me-history'});
				...
				learnerMeHistoryView.render('#uow-passport-me-history-dates-count-view');

				app.set(
				{
					scope: 'uow-passport-me-history',
					context: 'attributes',
				...
				if (response.data.rows.length != 0)
				{
					app.invoke('uow-passport-me-history-attributes')
				}
			}
		}
	}
...
app.add(
{
	name: 'uow-passport-me-history-attributes',
	code: function (param, response)
	{	
		var whoami = app.get(
		{
		...
		learnerMeHistoryDatesView = app.vq.init({queue: 'uow-passport-me-history-dates'});
		...
		learnerMeHistoryDatesView.render('#uow-passport-me-history-dates-view');
      ...
      app.vq.render('#uow-passport-me-history-attributes-view')	
	}
});
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		if (response == undefined)
		{
			...
			app.set(
			{
				scope: 'uow-passport-me-visual',
				context: 'category',
				value: attributesCategory
			});
		
			app.invoke('util-view-button-set-active', {selector: '#uow-passport-me-visual-for-' + attributesCategory});
 
			app.view.clear('#uow-passport-me-visual-view');
			app.view.clear('#uow-passport-me-visual-attributes-view');
			...
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-visual',
				callbackParam: param
			});
		}
		else
		{
			...
			if (response.status == 'OK')
			{
				...
				learnerMeVisualDatesView.render('#uow-passport-me-visual-dates-count-view');

				//if (attributes.length != 0)
				//{
					app.invoke('uow-passport-me-visual-refresh')
				//}
			}
		}
	}
...
app.add(
{
	name: 'uow-passport-me-visual-refresh',
	code: function (param, response)
	{	
		...
		{
			app.invoke('uow-passport-me-visual-attributes')
		}

		if (perspective == 'balance')
		{
			app.invoke('uow-passport-me-visual-attributes-balance')
		}

		if (perspective == 'balance-growth')
		{
			app.invoke('uow-passport-me-visual-attributes-growth')
		}

		if (perspective == 'balance-radar')
		{
			app.invoke('uow-passport-me-visual-attributes-balance-radar')
		}
	}
});
...
app.add(
{
	name: 'uow-passport-me-visual-attributes',
	code: function (param, response)
	{	
		app.set(
		{
		...
		learnerMeVisualDatesView = app.vq.init({queue: 'uow-passport-me-visual-dates'});
		...
		learnerMeVisualDatesView.render('#uow-passport-me-visual-dates-view');
	}
});

app.add(
{
	name: 'uow-passport-me-visual-attributes-balance',
	code: function (param, response)
	{	
		app.set(
		{
		...
		if (response == undefined)
		{
			...
			mydigitalstructure.cloud.search(
			{
				...
				callback: 'uow-passport-me-visual-attributes-balance',
				callbackParam: param
			});
		}
		else
...
app.add(
{
	name: 'uow-passport-me-visual-attributes-growth',
	code: function (param, response)
	{	
		app.set(
		{
...
app.add(
{
	name: 'uow-passport-me-visual-attributes-balance-radar',
	code: function (param, response)
	{	
		app.set(
		{
