...
app.add(
{
	name: 'util-ai-chat-with-assistant-show',
	code: function (param)
	{
		var data = app.get({scope: 'chat'});
		...
		[
			'<div class="mt-4 pt-30 pb-1">',
					...
					'<div class="">',
						'<div class="row">',
							'<div class="col-1 text-right pr-3">',
								...
								'>',
								'<img src="/site/2007/selfdriven-2-logo-round-purple-beige.png" class="img-responsive mx-auto rounded-circle" style="height:42px; padding-top: 2px;">',
								'</a>',
							'</div>',
							'<div class="col-10 px-0">',
								'<form autocomplete="off">',
									'<div class="input-group input-group-flush input-group-merge input-group-reverse">',
										'<input type="text" class="form-control input-lg entityos-text text-center input-rounded" data-enter="stop" data-clean="disabled" data-scope="util-ai" data-context="chat-with-assistant-text" id="util-ai-chat-with-assistant-text" placeholder="Chat with Assistant">',
									'</div>',
								'</form>',
							'</div>',
							'<div class="col-1 pl-2 mt-0">',
								'<button class="btn btn-default btn-outline entityos-click"',
									' data-controller="util-ai-chat-with-assistant-send"',
								'><i class="fa fa-arrow-up"></i></button>',
							'</div>',
						'</div>',
					'</div>',
				...
				'<div class="row mt-3 text-center">',
					'<div class="col-12">',
						'<input type="file" id="util-ai-chat-with-assistant-attach-file" class="entityos-change" data-controller="util-ai-chat-with-assistant-attach-select" data-context="file" style="display:none;"/>',
						'<button class="btn btn-default border btn-sm entityos-click rounded-pill" id="util-ai-chat-with-assistant-attach" data-controller="util-ai-chat-with-assistant-attach"><i class="fa fa-cloud-upload-alt"></i> Attach File</button>',
					'</div>',
				'</div>',
			'</div>',
			'<div id="util-ai-chat-with-assistant-view" class="text-center">',
				'<div class="row">',
					'<div class="col-12 mt-2">',
						'<button class="btn btn-default border btn-sm entityos-click rounded-pill"',
							' data-spinner',
							' data-controller="util-ai-chat-with-assistant-send" data-text="I\'m Bored"',
						'>I\'m Bored</button>',
						'<button class="btn btn-default border btn-sm entityos-click rounded-pill ms-2"',
							' data-spinner',
							' data-controller="util-ai-chat-with-assistant-send" data-text="I need ideas for my level up profile"',
		...
		chatDashboardView.add(
		[
			'<div id="util-ai-attach-with-assistant-file-view" class="text-center">',
			'</div>'
		]);
