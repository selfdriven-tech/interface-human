...
[
		...
		code: function (param)
		{
			...
			if (isLab)
			{
				...
				const authSettings =
				{
					...
					signup:
					{
						usernamepath: 'member.identifiers.username'
					}
				}
	...
	},
	{
		...
		code: function (param)
		{
			var data = app.get({scope: 'community'});
			...
			var communityDashboardView = app.view();
			...
			app.invoke('community-dashboard-process');
		}
	}
]);
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		else
		{
			...
			//app.invoke('community-dashboard-learning-e');
			//app.invoke('community-dashboard-conversations');
			//app.invoke('community-dashboard-resources');
		}
	}
});
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		else
		{
			...
			app.invoke('community-dashboard-conversations-posts');
		}
	}
});
...
app.add(
{
	...
	code: function (param, response)
	{
		...
		else
		{
			...
			//app.invoke('community-dashboard-events-attachments');
		}
	}
});
...
app.add(
{
	...
	code: function (param, response)
	{	
		var communitySignupData = app.get(
		{
...
{
	app.invoke('community-set-options');
	app.invoke('community-init');
}