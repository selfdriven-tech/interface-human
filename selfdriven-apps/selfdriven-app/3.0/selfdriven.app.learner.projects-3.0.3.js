...
entityos._util.controller.add(
{
    ...
    code: function ()
    {
		...
		search._type = 'project,learning,verification'
        ...
        else
        {
								...
								'<div class="col-12" data-context="{{name}}">',
									...
									'<div class="mt-3">',
										'<a class="btn btn-default btn-outline btn-sm entityos-collapse me-2" data-toggle="collapse" href="#learner-projects-templates-dashboard-skillzeb-info-view-{{name}}">',
											'View',
										'</a>',
										'<button class="btn btn-default btn-outline btn-sm entityos-click"',
											' data-context="{{name}}" data-id="{{name}}" data-controller="util-skillzeb-template-to-project-template">',
            ...
            _.each(templatesSet, function (template, t)
            {
                ...
                else
                {
					...
					template._typetext = (template.type == 'verification'?'Quiz':'Project')
...
app.add(
{
	...
	{	
		...
		data.projecttype = (data.type == app.whoami().mySetup.projectTypes.verification?'Quiz':'Project');
